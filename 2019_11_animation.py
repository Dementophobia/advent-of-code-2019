...
def draw_panel(panel, robot, step):
    scale = 12
    
    img = Image.new('RGBA', (40*scale, 6*scale), (255, 0, 0, 0))
    ...
    draw.ellipse((robot[0]*scale, robot[1]*scale, robot[0]*scale+scale-1, robot[1]*scale+scale-1), fill=(255, 0, 0))
    
    img.save(f"images\Panel{250-step}.png", 'PNG')
